#!/usr/bin/env python3
"""Write crypto_server.h and crypto_server.c to /tmp."""
...
void crypto_server_main(seL4_CPtr ep);
...
/* Use the AIOS printf if available, otherwise stub it out */
#ifndef aios_printf
#define aios_printf(...)
#endif
...
{{
    ...
    aios_printf("[crypto] server started, initial seed collected\\n");
...
print("==============================")
print("  03_crypto_server complete")
print("==============================")
