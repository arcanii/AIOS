...
IMPL_NOTES = {
    ...
    "fsync":        "no-op (write-through FS)",
    "fdatasync":    "no-op (write-through FS)",
    "flock":        "no-op (single-user)",
    "lockf":        "no-op (single-user)",
    "lstat":        "aliases stat (no symlinks)",
    "fchdir":       "stub (ENOSYS)",
    "fchmod":       "stub (ENOSYS)",
    "fchown":       "stub (ENOSYS)",
    "symlink":      "stub (ENOSYS)",
    ...
    "sscanf":       "stub (returns 0)",
    "fscanf":       "stub (returns 0)",
    "scanf":        "stub (returns 0)",
    "atof":         "stub (returns 0.0)",
    "strtod":       "stub (returns 0.0)",
    "strtof":       "stub (returns 0.0f)",
    "setuid":       "no-op (returns 0)",
    "setgid":       "no-op (returns 0)",
    "seteuid":      "no-op (returns 0)",
    "setegid":      "no-op (returns 0)",
    "sysconf":      "stub (returns -1)",
    "pathconf":     "stub (returns -1)",
    "fpathconf":    "stub (returns -1)",
    "tcsetattr":    "stub (returns 0)",
    "setjmp":       "stub (returns 0)",
    "longjmp":      "stub (infinite loop)",
    "sigsetjmp":    "stub (returns 0)",
    "siglongjmp":   "stub (infinite loop)",
